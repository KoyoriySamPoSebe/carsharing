 ...
 */
class Rent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Rent';
    ...
    protected static $openAPITypes = [
        ...
        'vehicle_id' => 'int',
        'driver_id' => 'int',
        'status' => '\OpenAPI\Client\Model\RentStatus',
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'location_start' => 'setLocationStart',
        'location_end' => 'setLocationEnd',
    ...
    protected static $getters = [
        ...
        'status' => 'getStatus',
        'location_start' => 'getLocationStart',
        'location_end' => 'getLocationEnd',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('location_start', $data ?? [], null);
        $this->setIfExists('location_end', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['location_start'] === null) {
            $invalidProperties[] = "'location_start' can't be null";
        }
        if ($this->container['location_end'] === null) {
            $invalidProperties[] = "'location_end' can't be null";
        }
        if ($this->container['cost_total'] === null) {
            $invalidProperties[] = "'cost_total' can't be null";
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\RentStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\RentStatus $status status
     *
     * @return self
     */
    ...
    {
        return $this->container['location_start'];
    }

    /**
     * Sets location_start
     *
     * @param string $location_start Start location
     *
     * @return self
     */
    public function setLocationStart($location_start)
    {
        if (is_null($location_start)) {
            throw new \InvalidArgumentException('non-nullable location_start cannot be null');
        }
        $this->container['location_start'] = $location_start;
    ...
    {
        return $this->container['location_end'];
    }

    /**
     * Sets location_end
     *
     * @param string $location_end End location
     *
     * @return self
     */
    public function setLocationEnd($location_end)
    {
        if (is_null($location_end)) {
            array_push($this->openAPINullablesSetToNull, 'location_end');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('location_end', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['location_end'] = $location_end;
     ...
     * Sets cost_total
     *
     * @param float $cost_total Total cost
     *
     * @return self
     */
    public function setCostTotal($cost_total)
    {
        if (is_null($cost_total)) {
            array_push($this->openAPINullablesSetToNull, 'cost_total');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cost_total', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
