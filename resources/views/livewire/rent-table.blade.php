            ...
            <table class="table table-hover text-nowrap">
                ...
                @forelse($rents as $rent)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('vehicles.edit', ['vehicle' => $rent->vehicle_id]) }}">
                                {{ $rent->vehicle_id }}
                            </a>
                        </td>
                        ...
                        <td>
                                <span class="badge badge-{{ $rent->is_active ? 'success' : 'danger' }}">
                        ...
                        <td>{{ $rent->finished_at }}</td>
                        <td>{{ number_format($rent->cost_total, 2) }}</td>
                    </tr>
                @empty
                    <tr>
